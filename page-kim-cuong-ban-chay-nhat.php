...
<div id="cat_banner">
    <img src="<?php echo JEMMIA_THEME_URL_IMG; ?>/1.3.jpg" alt="sản phẩm mới">
</div>
<div id="second-main">
        ...
        <div class="wrapper">
            <div id="content">
                <header class="woocommerce-products-header">
                    ...
                    <h1 class="woocommerce-products-header__title page-title cattitle">Trang sức kim cương bán chạy nhất</h1>
                        ...
                        $args = array(
                            ...
                            'tax_query' => array(
                                array(
                                    ...
                                    'field'    => 'slug',
                                    'terms'    => 'trang-suc-kim-cuong-tu-nhien',
                                ),),
